...
A Java 25 + JavaFX desktop application for creating club events, moving them through an approval workflow, and registering attendees with role-based pricing. Data is stored in the existing SQLite database.
